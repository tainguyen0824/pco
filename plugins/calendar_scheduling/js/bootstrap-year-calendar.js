 ...
 (function($) {
	...
	Calendar.prototype = {
		...
		_renderHeader: function() {
			...
			prevDiv.attr('onClick','NextYearEvent(this,"Prev")');
			...
			prev2YearDiv.addClass('year-title year-neighbor2 hidden-sm hidden-xs hidden-md hidden-lg');
			...
			prevYearDiv.addClass('year-title year-neighbor hidden-sm hidden-xs hidden-md hidden-lg');
			...
			nextYearDiv.addClass('year-title year-neighbor hidden-xs hidden-sm hidden-md hidden-lg');
			...
			next2YearDiv.addClass('year-title year-neighbor2 hidden-sm hidden-xs hidden-md hidden-lg');
			...
			nextDiv.attr('onClick','NextYearEvent(this,"Next")');
			if(this.options.maxDate != null && this.options.maxDate < new Date(this.options.startYear + 1, 0, 1)) {
